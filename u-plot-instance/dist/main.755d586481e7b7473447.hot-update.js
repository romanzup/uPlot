...
root.on('alert', function (value) {
  return console.log("".concat(value.value));
});
setTimeout(function () {
  Object(process__WEBPACK_IMPORTED_MODULE_4__["emit"])('alert', 100);
}, 5000);

/***/ })

})
//# sourceMappingURL=main.755d586481e7b7473447.hot-update.js.map